...
fun ActivityHomeScreen(
    ...
    // 1) PERIODO (DataStore)
    // =========================
    // ✅ Si tu BillingPeriodStore antiguo tenía periodFlow(context), cámbialo aquí.
    ...
    // Compat: para VM antiguo que requiere rango para stops
    ...
    // Añadir festivo (TextField visible)
    if (showAddHoliday) {
        AlertDialog(
    ...
    // Añadir vacaciones (TextField visible)
    if (showAddVacation) {
        AlertDialog(
