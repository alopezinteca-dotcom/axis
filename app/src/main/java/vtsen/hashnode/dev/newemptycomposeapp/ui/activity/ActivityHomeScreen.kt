...
importackbarHostStateimport android.app.Activity
...
fun ActivityHomeScreen(
    ...
    // ✅ Folder picker (SIN chooser ni setPackage)
    val folderPickerLauncher = rememberLauncherForActivityResult(
        ...
        // Persistir permisos (si granted viene vacío, intentamos READ|WRITE)
...
fun findChildDocIdByName(parentTreeUri: Uri, parentDocId: String, displayName: String): String? {    fun findChildDocIdByName(parentTreeUri: UriOverridesStore.addHoliday(context, d, holidayDesc)
                            holidayDesc = ""
...
``
    ...
    suspend fun writeCsvIntoAxisRoot(axisTreeUri: Uri, fileName: String, travels: List<TravelEntity>, stops: List<TravelStopEntity>) {
        ...
        // overwrite existing if possible; else delete+recreate
    ...
    fun doExportAll() {
        ...
        // PRO: si no hay permisos persistentes, pedimos carpeta
